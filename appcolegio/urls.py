...
urlpatterns += [
    ...
    path('alumno_list/', views.alumnoslista.as_view(), name="AlumnosLista"),
]
...
urlpatterns += [
    path('cursosMaterias/', views.CursoMaterias, name='CursosMaterias'),
    
    path('cursoMateria-create/', views.cursoMateriaCreate.as_view(), name="cursoMateriaCreate"),
    path('cursoMateria-detalle/', views.cursoMateriasDetalle, name="cursoMateriaDetalle"),
